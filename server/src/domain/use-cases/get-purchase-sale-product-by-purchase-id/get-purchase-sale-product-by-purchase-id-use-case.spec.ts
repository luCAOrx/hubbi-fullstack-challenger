      ...
      .then(async ({ purchase }) => {
        await getPurchaseSaleProductByPurchaseId
          ...
          .then(({ purchaseSaleProduct }) => {
            ...
            deepStrictEqual(
              purchaseSaleProduct.sale.products![3].props.name,
              "Cachorro quente 3",
            );
            deepStrictEqual(
              purchaseSaleProduct.sale.products![4].props.name,
              "Cachorro quente 4",
            );
            deepStrictEqual(
              purchaseSaleProduct.sale.products![5].props.name,
              "Cachorro quente 5",
            );
            deepStrictEqual(
              purchaseSaleProduct.sale.products![6].props.name,
              "Cachorro quente 6",
            );
            deepStrictEqual(
              purchaseSaleProduct.sale.products![7].props.name,
              "Cachorro quente 7",
            );
            deepStrictEqual(
              purchaseSaleProduct.sale.products![8].props.name,
              "Cachorro quente 8",
            );
            deepStrictEqual(
              purchaseSaleProduct.sale.products![9].props.name,
              "Cachorro quente 9",
            );
            deepStrictEqual(
              purchaseSaleProduct.sale.products![10].props.name,
              "Cachorro quente 10",
            );
            deepStrictEqual(
              purchaseSaleProduct.sale.products![11].props.name,
              "Cachorro quente 11",
            );
            deepStrictEqual(
              purchaseSaleProduct.sale.products![12].props.name,
              "Cachorro quente 12",
            );
            deepStrictEqual(
              purchaseSaleProduct.sale.products![13].props.name,
              "Cachorro quente 13",
            );
            deepStrictEqual(
              purchaseSaleProduct.sale.products![14].props.name,
              "Cachorro quente 14",
            );
            deepStrictEqual(
              purchaseSaleProduct.sale.products![15].props.name,
              "Cachorro quente 15",
            );
            deepStrictEqual(
              purchaseSaleProduct.sale.products![16].props.name,
              "Cachorro quente 16",
            );
            deepStrictEqual(
              purchaseSaleProduct.sale.products![17].props.name,
              "Cachorro quente 17",
            );
            deepStrictEqual(
              purchaseSaleProduct.sale.products![18].props.name,
              "Cachorro quente 18",
            );
            deepStrictEqual(
              purchaseSaleProduct.sale.products![19].props.name,
              "Cachorro quente 19",
            );

            deepStrictEqual(purchaseSaleProduct.sale.products?.length, 20);
            deepStrictEqual(
              purchaseSaleProduct.purchaseSaleProducts.length,
              20,
            );
          });
      });
